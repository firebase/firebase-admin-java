...
public class PercentCondition {
    ...
    /**
     * Create a percent condition for {@link PercentConditionOperator.GREATER_THAN} and {@link PercentConditionOperator.LESS_OR_EQUAL}.
     * 
     * @param microPercentRange
     * @param percentConditionOperator
     * @param seed
     */
    public PercentCondition(MicroPercentRange microPercentRange, PercentConditionOperator percentConditionOperator, String seed) {
