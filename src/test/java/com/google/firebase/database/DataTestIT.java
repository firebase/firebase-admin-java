...
public class DataTestIT {
  ...
  public void removeCallbackIsHit()
    ...
    readFuture.timedGet();
    assertTrue(callbackHit.tryAcquire(1, TestConstants.TEST_TIMEOUT, MILLISECONDS));
  ...
  public void removeCallbackIsHitForNodesThatAreAlreadyRemoved()
    ...
    assertTrue(callbackHit.tryAcquire(2, TestConstants.TEST_TIMEOUT, TimeUnit.MILLISECONDS));
  }
  ...
  public void setPriorityOnNonexistentNodeFails() throws DatabaseException, InterruptedException {
    ...
    assertTrue(semaphore.tryAcquire(1, TestConstants.TEST_TIMEOUT, TimeUnit.MILLISECONDS));
  }
  ...
  public void namespaceAreCaseInsensitive()
    ...
    DatabaseReference ref1 =
        new DatabaseReference(TestConstants.TEST_NAMESPACE + "/" + child, ctx1);
    DatabaseReference ref2 =
        new DatabaseReference(
            "http://"
                + TestConstants.TEST_REPO.toUpperCase()
                + "."
                + TestConstants.TEST_SERVER
                + "/"
                + child,
            ctx2);
  ...
  public void namespacesAreCaseInsensitiveInToString() throws DatabaseException {
    DatabaseConfig ctx = TestHelpers.getContext(0);
    DatabaseReference ref1 = new DatabaseReference(TestConstants.TEST_NAMESPACE, ctx);
    DatabaseReference ref2 =
        new DatabaseReference(
            "http://" + TestConstants.TEST_REPO.toUpperCase() + "." + TestConstants.TEST_SERVER,
            ctx);
