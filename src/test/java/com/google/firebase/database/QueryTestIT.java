...
public class QueryTestIT {
  ...
  // TODO(dimond): find a way to expose listens from PersistentConnection interface
  ...
  @Test
  @Ignore // TODO(dimond): re-enable once dumpListens is implemented again
  ...
  @Test
  @Ignore // TODO(mikelehen): This test depends on a specific JSON rendering of listens and is
        ...
        new ReadFuture(
            ...
            new ReadFuture.CompletionCondition() {
              ...
              public boolean isComplete(List<EventRecord> events) {
                ...
                // We already initialized the location, and now the remove has happened so that we have no more data
