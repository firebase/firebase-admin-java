...
/**
 * Tests for {@link FirebaseRemoteConfigClientImpl}.
 */
public class FirebaseRemoteConfigClientImplTest {
  ...
  private static final ServerTemplateData EXPECT_SERVER_TEMPLATE_DATA =
      new ServerTemplateData()
          .setETag(TEST_ETAG)
          .setParameters(EXPECTED_PARAMETERS)
          .setParameterGroups(EXPECTED_PARAMETER_GROUPS)
          .setServerConditions(EXPECTED_SERVER_CONDITIONS)
          .setVersion(EXPECTED_VERSION);
